...
|2014.08|株式会社イー・バード 所属部署変更 エンジニア・ディレクターへの業務転換|
|2019.03|株式会社イー・バード 退社|
...
## 自己PR
Webサイトやアプリケーションのデザイン/UI設計から、最終的な実装まで全ての工程で携わり、ほぼ一通りの制作経験あり。顧客対応まで可能です。
実装ルールがバラバラだったシステム構築のルールを統一する目的で、HTMLマークアップ仕様書や[WordPressの構築設計ガイドライン](https://qiita.com/kgsi/items/65ee2d7814e5cfa199d2)などをアウトプット
