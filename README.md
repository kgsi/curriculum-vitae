...
#### フロントエンドエンジニア・Webディレクター : 2014.08 - 現在
...
## 自己PR
所属している会社の特徴で代理店を通さず、直で受注する案件が多くを占めるため、必然的にWebサイトやアプリケーションのデザイン/UI設計から最終的な実装まで全ての工程で関わることが多く、ほぼ一通りの制作経験を積むことができました。今現在は顧客対応まで対応範囲が広がり、ワンストップで制作・開発業務を担当しています。

また、開発部に所属してからは実装ルールがバラバラだったシステム構築のルールをある程度統一する目的で、マークアップ仕様書や[WordPressの構築設計ガイドライン](https://qiita.com/kgsi/items/65ee2d7814e5cfa199d2)などをまとめ、社内からの発注レベル、制作レベルを一定値以上に上げる活動を行っています。
